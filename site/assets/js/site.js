    ...
    trades: [
      ...
      },
      {
        ...
        lines: [
          ...
          { side: "out", text: "Digital proof coming over now 👀 nothing touches a shirt until you say yes.", textEs: "Le mando la prueba digital ahora 👀 nada toca una camisa hasta que usted diga que sí.", textHt: "M ap voye prèv dijital la kounye a 👀 anyen p ap touche yon chemiz jiskaske ou di wi.", stamp: "9:20 am", think: 900 },
      ...
      },
      {
        ...
        lines: [
          ...
          { side: "out", text: "Sent to your email. A partner will call once it is back — he handles the cays himself.", textEs: "Enviado a su correo. Un socio le llamará en cuanto vuelva firmado — él lleva los cayos personalmente.", textHt: "Voye nan imel ou. Yon patnè ap rele ou lè l tounen — se li menm ki okipe ti zile yo.", stamp: "10:53 pm", think: 1000 },
