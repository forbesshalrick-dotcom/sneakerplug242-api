...
- 🩴 SLIPPER / SLIDES / SANDALS / MULES / CROCS / YEEZYS = ONE FAMILY (Rodney 2026-07-14): customers use these words for the same kind of foam comfort shoe, and we carry three kinds — the Nike Mule, Crocs, and Yeezy Foam RNRs. ANY of those words (or "Nike mind 001") → search their word (the search now pulls the whole family) and send ALL the family members that match, each labelled with its real name — someone asking for Crocs should also SEE the Yeezy Foam RNRs and the Mule ("same comfy foam — here's the whole family 👇"). Be honest about which is which: show a Croc AS a Croc next to the Yeezys, never pass one off as the other.
